...
the legacy behavior of aiSSEMBLE and should only be undertaken with due consideration. In order to do this, first delete
generated spark pipelines if necessary and update the
