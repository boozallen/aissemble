...
|Data Access                            | `data-access-trino-deploy-v2`              |https://github.com/boozallen/aissemble/blob/{git-tree}/extensions/extensions-helm/aissemble-trino-chart/README.md[Trino,role=external,window=_blank]
...
|Lineage HTTP Consumer                  | `lineage-http-consumer-deploy-v2`          |https://github.com/boozallen/aissemble/blob/{git-tree}/extensions/extensions-helm/aissemble-lineage-http-consumer-chart/README.md[Lineage HTTP Consumer,role=external,window=_blank]
...
|Pipeline Invocation Service            | `pipeline-invocation-service-v2`           |https://github.com/boozallen/aissemble/blob/{git-tree}/extensions/extensions-helm/extensions-helm-pipeline-invocation/aissemble-pipeline-invocation-app-chart/README.md[Pipeline Invocation Service,role=external,window=_blank]
