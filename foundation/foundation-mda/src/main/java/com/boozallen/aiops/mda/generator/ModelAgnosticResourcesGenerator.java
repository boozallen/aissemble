...
public class ModelAgnosticResourcesGenerator extends AbstractModelAgnosticGenerator {
     ...
     * | baseSparkProperties                | deployment/spark-infrastructure/configurations/base/spark.properties.vm  | configurations/base/spark.properties            |
     * | envSparkProperties                 | deployment/spark-infrastructure/configurations/env/spark.properties.vm   | configurations/env/spark.properties             |
