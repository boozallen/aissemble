...
class AiopsSecurityException(Exception):
    pass
...
class JsonWebTokenUtil:
    ...
    def validate_token(self, token: str) -> None:
        """
        Validates the given token and will raise an AiopsSecurityException when the token fails validation.
        """
        ...
        if auth_exception_details:
            ...
            raise AiopsSecurityException(auth_exception_details)
