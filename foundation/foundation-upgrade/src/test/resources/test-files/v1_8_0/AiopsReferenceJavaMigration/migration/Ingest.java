...
import com.boozallen.aiops.security.exception.AissembleSecurityException;
 ...
 *
 * GENERATED CODE - DO NOT MODIFY (add your customizations in Ingest).
 *
 * Generated from: templates/data-delivery-spark/synchronous.processor.base.java.vm
 */
public abstract class Ingest extends AbstractPipelineStep {

    private static final Logger logger = LoggerFactory.getLogger(Ingest.class);

    protected static final String stepPhase = "Ingest";

    protected Ingest(String subject, String action) {
