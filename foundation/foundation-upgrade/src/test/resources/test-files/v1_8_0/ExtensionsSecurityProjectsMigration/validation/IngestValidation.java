...
public class Ingest extends IngestBase {
    ...
    private static AissembleKeycloakSecureTokenServiceClient keycloakSecureTokenServiceClient = new AissembleKeycloakSecureTokenServiceClient();
    private static AissembleKeyStore keyStore = new AissembleKeyStore();
    private static AissembleSimpleSecureTokenServiceClient simpleSecureTokenServiceClient = new AissembleSimpleSecureTokenServiceClient();

    // testing aissemble/security/authorization/policy/ migrations
    private static AissembleAttribute attribute = new AissembleAttribute();
    ...
    private static AissembleSecurityException securityException = new AissembleSecurityException();
