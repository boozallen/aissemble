...
The Configuration Store also support simplified way to provide configurations instead of mounting properties files.

Under values.yaml, https://github.com/boozallen/aissemble/blob/dev/extensions/extensions-helm/aissemble-configuration-store-chart/README.md[specifying base and environment specific properties,role=external,window=_blank] can act as configuration properties file
