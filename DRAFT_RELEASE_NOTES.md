...
- Upgraded Pydantic v1.10.x to 2.8.x to incorporate performance improvement and incorporate the availability of new features for future. See [here](https://docs.pydantic.dev/latest/migration/) for the guide on how to migrate pydantic V1 into V2.
