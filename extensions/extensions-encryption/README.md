...
`mvn clean install -pl :foundation-encryption-policy-java,:aissemble-foundation-encryption-policy-python,:extensions-encryption-vault-java,:aissemble-extensions-encryption-vault-python,:aissemble-vault`
...
`mvn clean install -pl :extensions-encryption-vault-java,:aissemble-extensions-encryption-vault-python -Pintegration-test`
