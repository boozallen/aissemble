...
| configMap.baseSparkProperties                               | The base Spark properties for Universal Configuration                                                                                                                                                                                                                        | No                | config-store-quarkus-config                                                                                                                                                                                                     |
| configMap.envSparkProperties                                | The environment specific Spark properties for Universal Configuration                                                                                                                                                                                                        | No                | config-store-quarkus-config                                                                                                                                                                                                     |
...
| configStore.baseVolumeMounts                                | The ConfigStore base volume mounts for the pod                                                                                                                                                                                                                               | No                | `/etc/webhook/cert=certs`                                                                                                                                                                                                       |

## Configuration Store Properties
The following properties are used injected in configMap to mount configuration properties file in the downstream project.

| Property                                     | Description                                              | Required Override | Default                         |
|----------------------------------------------|----------------------------------------------------------|-------------------|---------------------------------|
| baseconfigMap.name                           | The name of base Configuration properties configMap      | No                | base-configuration-store-config |
| baseconfigMap.configFiles                    | The list of base config properties files to mount        | No                | spark.properties:               |
| envconfigMap.name                            | The name of base Configuration properties configMap      | No                | env-configuration-store-config  |
| envconfigMap.configFiles                     | The list of environment config properties files to mount | No*               | spark.properties:               |
...
## Defining Properties Files

The Configuration Store support simplified way to provide configurations instead of mounting properties files.
The user can define its configuration properties within values.yaml file as below:

```yaml
baseconfigMap:
  name: base-configuration-store-config
  configFiles:
    spark.properties: |-
...
envconfigMap:
  name: env-configuration-store-config
  configFiles:
    spark.properties: |-
      connector=smallrye-kafka
