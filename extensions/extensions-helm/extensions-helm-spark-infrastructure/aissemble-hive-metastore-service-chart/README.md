...
| auth.username    | $getConfigValue(groupName=spark;propertyName=metastore.db.username) |
| auth.password    | $getConfigValue(groupName=spark;propertyName=metastore.db.password) |
